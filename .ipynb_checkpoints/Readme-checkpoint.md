...
* **⚖️ Consistency Check:** A specialized loop that forces the generated scoreline to match the Machine Learning prediction (prevents "Team A wins" with a "0-1" score).
